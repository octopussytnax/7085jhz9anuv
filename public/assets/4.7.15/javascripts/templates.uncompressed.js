...
this["JST"]["cartodb/dashboard/content_footer/filter_shortcut/locked_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<i class="CDB-IconFont CDB-IconFont-lock ContentFooter-lockedIcon"></i>\n<a href="' +
__e( url ) +
'" class="CDB-Text CDB-Size-medium">Show your ' +
__e( totalCount ) +
' locked ' +
__e( pluralizedContents ) +
'</a>\n';
...
this["JST"]["cartodb/dashboard/content_footer/filter_shortcut/non_locked_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="' +
...
this["JST"]["cartodb/dashboard/editable_fields/editable_description"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
 ...
 if (value.safeHTML) { ;
__p += '\n  <p class="u-ellipsis CDB-Text CDB-Size-medium u-secondaryTextColor js-description"  title="' +
__e( value.clean ) +
'">' +
((__t = ( value.clean )) == null ? '' : __t) +
'</p>\n';
 } else { ;
__p += '\n  ';
 if (editable) { ;
__p += '\n    <button class="EditableField-button CDB-Text CDB-Size-medium u-actionTextColor js-add-btn">Add description...</button>\n    <textarea class="EditableField-input CDB-Text CDB-Size-medium u-secondaryTextColor js-field-input" maxlength="' +
__e( maxLength ) +
'"></textarea>\n  ';
 } else { ;
__p += '\n  <div class="DefaultDescription CDB-Text CDB-Size-medium u-altTextColor">\n    <span class="NoResults">No description</span>\n  </div>\n  ';
 } ;
__p += '\n';
 } ;
__p += '\n\n\n';
...
this["JST"]["cartodb/dashboard/editable_fields/editable_tags"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
__p += '\n      <a class="CDB-Tag CDB-Text CDB-Size-small is-semibold u-upperCase js-tag-link" href="' +
__e( router.currentUrl({ search: ':'+ tags[i], page: 1 }) ) +
'">' +
__e( tags[i] ) +
'</a>';
 if (i != (l-1)) { ;
...
__p += '\n    ';
 if (tagsCount > 3) { ;
__p += '\n      <span class="CDB-Text CDB-Size-small u-altTextColor u-lSpace">and ' +
__e( tagsCount - 3) +
' more</span>\n    ';
 } ;
__p += '\n  </div>\n';
...
__p += '\n  ';
 if (editable) { ;
__p += '\n    <button class="EditableField-button CDB-Text CDB-Size-medium u-actionTextColor js-add-btn">Add tags...</button>\n    <input type="text" class="EditableField-input CDB-Text CDB-Size-medium u-altTextColor js-field-input"></input>\n  ';
 } else { ;
__p += '\n    <div class="DefaultTags">\n      <span class="NoResults CDB-Text CDB-Size-small u-altTextColor">No tags</span>\n    </div>\n  ';
 } ;
__p += '\n';
 } ;
__p += '\n';
...
this["JST"]["cartodb/dashboard/maps/placeholder_item"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="MapCard">\n  <div class="MapCard-fake"></div>\n  <div class="MapCard-header MapCard-header--fake">\n    <i class="MapCard-headerFakeIcon CDB-IconFont CDB-IconFont-' +
__e( icon ) +
'" />\n  </div>\n  <div class="MapCard-content">\n    <div class="MapCard-contentBody">\n      <div class="MapCard-contentBodyRow">\n        <p class="MapCard-desc MapCard-desc--fake DefaultDescription CDB-Text CDB-Size-medium u-secondaryTextColor">' +
__e( desc ) +
...
this["JST"]["cartodb/dashboard/views/categories"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<div class="u-inner">\n  <a href="#/category" class="Categories-breadcrumb DropdownLink">' +
__e( currentCategory ? currentCategory : 'By category' ) +
'</a>\n  <ul class="Categories-list">\n    <li class="Category-listItem">\n      <a href="#/all" data-title="All" class="Categories-option ' +
__e( !currentCategory ? 'is-selected' : '' ) +
'">\n        <i class="CDB-IconFont CDB-IconFont-dribbble Categories-optionIcon"></i>\n      </a>\n    </li>\n    ';
 for (var i = 0, l = categories.length; i < l; i++) { ;
__p += '\n      <li class="Categories-listItem">\n        <a href="#/' +
__e( category[i].get('name') ) +
'" data-title="' +
__e( category[i].get('name') ) +
'" class="Categories-option ' +
__e( currentCategory === category[i].get('name') ? 'is-selected' : '' ) +
'">\n          <i class="CDB-IconFont CDB-IconFont-' +
__e( category[i].get('name') ) +
' Categories-optionIcon"></i>\n        </a>\n      </li>\n    ';
 } ;
__p += '\n  </ul>\n</div>';
...
this["JST"]["cartodb/dashboard/views/content_error"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="IntermediateInfo">\n  <div class="LayoutIcon LayoutIcon--negative">\n    <i class="CDB-IconFont CDB-IconFont-cockroach"></i>\n  </div>\n  <h4 class="CDB-Text CDB-Size-large u-mainTextColor u-secondaryTextColor u-bSpace--m u-tSpace-xl">Oouch! There has been an error</h4>\n  <p class="CDB-Text CDB-Size-medium u-altTextColor">Try viewing <a class="ContentResult-urlLink js-link" href="' +
...
this["JST"]["cartodb/dashboard/views/content_loader"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="IntermediateInfo">\n  <div class="Spinner"></div>\n  <h4 class="CDB-Text CDB-Size-large u-mainTextColor u-secondaryTextColor u-bSpace--m u-tSpace-xl">' +
...
this["JST"]["cartodb/dashboard/views/content_no_datasets"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<h4 class="CDB-Text CDB-Size-large u-mainTextColor u-secondaryTextColor u-bSpace--m u-tSpace-xl">You have not connected any datasets yet</h4>\n<p class="CDB-Text CDB-Size-medium u-altTextColor">\n  You can <button class="Button--link js-connect">connect datasets</button> or <strong>search</strong> in all our data library .\n</p>\n<div class="NoDatasets-illustration"></div>\n';

}
return __p
};

this["JST"]["cartodb/dashboard/views/content_no_results"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<div class="IntermediateInfo">\n  <div class="LayoutIcon ';
 isSearching ? 'LayoutIcon--negative' : '' ;
__p += '">\n    <i class="CDB-IconFont\n      ';
 if (shared === "only") { ;
__p += ' CDB-IconFont-defaultUser\n      ';
 } else if (liked) { ;
__p += ' CDB-IconFont-heartEmpty\n      ';
 } else if (locked) { ;
__p += ' CDB-IconFont-lock\n      ';
 } else { ;
__p += ' CDB-IconFont-lens ';
...
__p += '\n  </h4>\n  <p class="CDB-Text CDB-Size-medium u-altTextColor">\n    ';
 if (page > 1 || totalItems === 0 && totalEntries > 0) { ;
__p += '\n      Back to your <a class="ContentResult-urlLink" href="' +
__e( defaultUrl ) +
'">first page</a>\n    ';
 } ;
__p += '\n\n    ';
...
__p += '\n\n    ';
 if (liked && totalEntries === 0 ) { ;
__p += '\n      Fill this section up by clicking the heart on CARTO ' +
__e( type ) +
' published on the web or on user profile pages\n    ';
 } ;
__p += '\n  </p>\n</div>\n';
...
this["JST"]["cartodb/dashboard/views/content_small_loader"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="ContentResult is-empty">\n  <div class="ContentResult-smallLoader"></div>\n</div>\n';

}
return __p
};

this["JST"]["cartodb/dashboard/views/datasets_item"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<div class="DatasetsList-fake"></div>\n<div class="DatasetsList-itemCategory is--' +
__e( isRaster ? 'raster' : geometryType ) +
'Dataset">\n  ';
 if (syncStatus) { ;
__p += '\n    <i\n    ';
...
__p += '\n  ';
 if (fromExternalSource) { ;
__p += '\n    <i data-title="Public dataset" class="CDB-IconFont CDB-IconFont-book DatasetsList-itemStatus DatasetsList-aditionalItemStatus js-public is-public"></i>\n  ';
 } ;
__p += '\n</div>\n<div class="DatasetsList-itemInfo">\n  <div class="DatasetsList-itemPrimaryInfo">\n    <h3 class="DatasetsList-itemTitle">\n      ';
 if (isRaster) { ;
__p += '\n        <p title="' +
__e( title ) +
'" class="DatasetsList-itemTitle CDB-Text CDB-Size-large is-disabled u-ellipsLongText">' +
__e( title ) +
'</p>\n      ';
 } else { ;
__p += '\n        <a href="' +
...
'" title="' +
__e( title ) +
'" class="u-ellipsis CDB-Text CDB-Size-large u-mainTextColor">' +
__e( title ) +
'</a>\n      ';
 } ;
__p += '\n      ';
...
'\n          ';
 if (!isOwner) { ;
__p += '\n            by\n            <span class="UserAvatar u-lSpace" data-title="' +
__e( owner.name || owner.username  ) +
'">\n              <img class="UserAvatar-img UserAvatar-img--smaller" src="' +
__e( owner.avatar_url ) +
'" />\n            </span>\n          ';
...
this["JST"]["cartodb/dashboard/views/deep_insights_item"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="MapCard">\n  <a href="' +
__e( url ) +
'" class="MapCard-header js-header"></a>\n  <div class="MapCard-content">\n    <div class="MapCard-contentBody">\n      <div class="MapCard-contentBodyRow MapCard-contentBodyRow--flex">\n        <h3 class="MapCard-title DefaultTitle CDB-Text is-semibold CDB-Size-large u-ellipsLongText">\n          <a class="DefaultTitle-link" title="' +
__e( title ) +
'" href="' +
__e( url ) +
'">' +
__e( title ) +
'</a>\n        </h3>\n      </div>\n      <div class="MapCard-contentBodyRow MapCard-contentBodyRow--flex">\n        <div class="MapCard-desc js-item-description">\n          <div class="DefaultDescription" title="asdfasdf">\n            <p>' +
__e( description ) +
...
this["JST"]["cartodb/dashboard/views/fake_datasets_item"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="DatasetsList-fake"></div>\n<div class="LayoutIcon DatasetsList-itemCategory is-empty">';

}
return __p
};

this["JST"]["cartodb/dashboard/views/fake_maps_item"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/dashboard/views/filters"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
__e( currentDashboardUrl ) +
'" class="Filters-typeLink CDB-Text CDB-Size-medium is-semibold u-upperCase js-link ' +
__e( shared === "no" && !liked && !library ? 'is-selected' : '' ) +
'">\n              ';
 if (totalItems) { ;
__p += '\n                <strong>' +
__e( totalItems ) +
...
'\n            </a>\n          </li>\n          ';
 if (isInsideOrg) { ;
__p += '\n            <li class="Filters-typeItem">\n              <a class="Filters-typeLink CDB-Text CDB-Size-medium is-semibold u-upperCase js-link ' +
__e( shared === "only" ? 'is-selected' : '' ) +
'" href="' +
__e( currentDashboardUrl.sharedItems() ) +
'">\n                ';
 if (totalShared) { ;
__p += '\n                  <strong>' +
__e( totalShared ) +
...
__p += '\n          <li class="Filters-typeItem">\n            <a class="Filters-typeLink CDB-Text CDB-Size-medium is-semibold u-upperCase js-link ' +
__e( liked ? 'is-selected' : '' ) +
'" href="' +
__e( currentDashboardUrl.likedItems() ) +
'">\n              ';
 if (totalLiked) { ;
__p += '\n                <strong>' +
__e( totalLiked ) +
...
__p += '\n            <li class="Filters-typeItem CDB-Text CDB-Size-medium is-semibold u-upperCase">\n              <a class="Filters-typeLink js-link ' +
__e( library ? 'is-selected' : '' ) +
'" href="' +
__e( currentDashboardUrl.dataLibrary() ) +
'">\n                Data library\n              </a>\n            </li>\n          ';
 } ;
__p += '\n        </ul>\n      </div>\n\n      <div class="Filters-typeItem Filters-typeItem--searchField js-search-field">\n        <form class="Filters-searchForm js-search-form" action="' +
__e( router.currentUrl({ search: '', shared: 'yes', locked: false, liked: false  }) ) +
'">\n          <input class="Filters-searchInput CDB-Text CDB-Size-medium js-search-input" type="text" value="' +
__e( ( tag && (':' + tag) ) || q ) +
'" placeholder="by name, description or :tag" />\n          ';
 if (tag || q) { ;
__p += '\n            <a href="' +
__e( router.currentUrl({ search: '', tag: '', shared: 'no' }) ) +
'" class="Filters-cleanSearch js-clean-search">\n              <div class="CDB-Shape">\n                <div class="CDB-Shape-close is-blue is-large"></div>\n              </div>\n            </a>\n          ';
 } ;
__p += '\n        </form>\n      </div>\n\n      <div class="Filters-group js-order-list">\n        <ul class="Filters-group">\n          <li class="Filters-orderItem">\n            <a data-title="date" class="js-order-link Filters-orderLink Filters-orderLink--clock js-updated_at ' +
__e( !order || order === 'updated_at' ? 'is-selected' : '' ) +
'" href="#/time">\n              <i class="CDB-IconFont CDB-IconFont-clock"></i>\n            </a>\n          </li>\n          <li class="Filters-orderItem">\n            <a data-title="visits" class="js-order-link Filters-orderLink Filters-orderLink--graph js-mapviews ' +
__e( order === 'mapviews' ? 'is-selected' : '' ) +
'" href="#/views">\n              <i class="CDB-IconFont CDB-IconFont-stats"></i>\n            </a>\n          </li>\n          <li class="Filters-orderItem">\n            <a data-title="likes" class="js-order-link Filters-orderLink Filters-orderLink--heart js-likes ' +
__e( order === 'likes' ? 'is-selected' : '' ) +
'" href="#/likes">\n              <i class="CDB-IconFont CDB-IconFont-heartEmpty"></i>\n            </a>\n          </li>\n          ';
 if (!isMaps) { ;
__p += '\n            <li class="Filters-orderItem">\n              <a data-title="size" class="js-order-link Filters-orderLink Filters-orderLink--size js-size ' +
__e( order === 'size' ? 'is-selected' : '' ) +
...
__e( !isMaps && !canCreateDatasets ? 'is-disabled' : ''  ) +
'\n            ' +
__e( isMaps ? 'js-new_map' : 'js-new_dataset' ) +
'\n            ">\n            <span class="CDB-Button-Text CDB-Text is-semibold CDB-Size-small u-upperCase">' +
__e( isMaps ? 'New Map' : 'New dataset' ) +
'</span>\n          </button>\n        ';
 } ;
__p += '\n      </div>\n    </div>\n\n    <div class="Filters-row">\n      <label class="CDB-Text CDB-Size-medium u-secondaryTextColor">' +
__e( selectedItemsCount ) +
' ' +
__e( pluralizedContentTypeSelected ) +
...
__p += '\n                <a class="Filters-actionsLink CDB-Text CDB-Size-medium js-select_all" href="#/select-all">Select all ' +
__e( tag || q ? 'yours' : '' ) +
'</a>\n              ';
 };
__p += '\n              ';
 if (selectedItemsCount > 1) { ;
__p += '\n                <a class="Filters-actionsLink CDB-Text CDB-Size-medium js-deselect_all" href="#/deselect-all">Deselect all ' +
__e( tag || q ? 'yours' : '' ) +
'</a>\n              ';
 } ;
__p += '\n            </li>\n          ';
...
__p += '\n                <span class="Filters-actionsText CDB-Text CDB-Size-medium u-secondaryTextColor">Max map layers selected (' +
__e( maxLayersByMap ) +
' max)</span>\n              ';
 } ;
__p += '\n            </li>\n          ';
...
__p += '\n            <li class="Filters-actionsItem">\n              <a class="Filters-actionsLink CDB-Text CDB-Size-medium is--critical js-delete" href="#/delete">Delete ' +
__e( tag || q ? 'your' : '' ) +
' ' +
__e( pluralizedContentTypeSelected ) +
'&hellip;</a>\n            </li>\n          ';
...
this["JST"]["cartodb/dashboard/views/filters_deep_insights"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
this["JST"]["cartodb/dashboard/views/maps_item"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
'</a>\n        </h3>\n        <a href="' +
__e( url ) +
'" class="MapCard-editButton CDB-IconFont CDB-IconFont-pencil" title="' +
__e( name ) +
'"></a>\n        ';
 if (showPermissionIndicator) { ;
...
__p += '\n          </span>\n          ';
 if (!isOwner) { ;
__p += '\n            <span class="UserAvatar" data-title="' +
__e( owner.name || owner.username  ) +
'">\n              <img class="UserAvatar-img UserAvatar-img--smaller" src="' +
__e( owner.avatar_url ) +
'" />\n            </span>\n          ';
...
this["JST"]["cartodb/dashboard/views/remote_datasets_item"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
'Dataset">\n  <i data-title="Public dataset" class="CDB-IconFont CDB-IconFont-book DatasetsList-itemStatus ' +
__e( canImportDataset ? 'is-public' : 'is-banned' ) +
'"></i>\n</div>\n<div class="DatasetsList-itemInfo">\n  <div class="DatasetsList-itemPrimaryInfo">\n    <h3 class="u-ellipsis CDB-Text CDB-Size-large u-mainTextColor">' +
__e( title ) +
'</h3>\n    ';
 if (description && description.length > 0) { ;
__p += '\n      <p class="DefaultDescription CDB-Text CDB-Size-medium u-secondaryTextColor u-ellipsis" title="' +
__e( description ) +
'">' +
__e( description ) +
'</p>\n    ';
...
__p += '\n        <div class="DefaultTags DatasetsList-itemTags">\n          ';
 for (var i = 0, l = Math.min(maxTagsToShow, tags.length); i < l; ++i) { ;
__p += '\n            <a class="CDB-Tag CDB-Text CDB-Size-small is-semibold u-upperCase js-tag-link" href="' +
__e( router.currentUrl({ search: ':'+ tags[i], library: false, page: 1 }) ) +
'">' +
__e( tags[i] ) +
'</a>';
 if (i !== (l-1)) { ;
...
this["JST"]["cartodb/data_library/content/error_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="IntermediateInfo">\n  <div class="LayoutIcon LayoutIcon--negative">\n    <i class="CDB-IconFont CDB-IconFont-cockroach"></i>\n  </div>\n  <h4 class="CDB-Text CDB-Size-large u-mainTextColor u-secondaryTextColor u-bSpace--m u-tSpace-xl">Oouch! There has been an error</h4>\n  <p class="CDB-Text CDB-Size-medium u-altTextColor">If the problem persists contact us at <a class="js-mail-link" href="mailto:support@carto.com">support@carto.com</a>.</p>\n</div>\n';
...
this["JST"]["cartodb/data_library/content/list/dataset_item_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
'">';
 if (vis.display_name == "" || vis.display_name == null) { ;
__p +=
__e( vis.name );
 } else { ;
__p +=
...
this["JST"]["cartodb/data_library/content/list/placeholder_item_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/data_library/content/loader_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/data_library/content/more_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/data_library/content/no_results_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/data_library/filters/dropdown/template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/data_library/filters/template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
this["JST"]["cartodb/data_library/header/template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/explore/dataset_item_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<li class="FeedItem FeedItem--card">\n  <a href="//' +
__e( vis.username ) +
'.' +
__e( account_host ) +
'" class="FeedItem-avatar">\n    <img src="' +
__e( vis.avatar_url ) +
'" class="UserAvatar-img UserAvatar-img--big" />\n  </a>\n  <div class="DatasetCard DatasetCard--explore" data-vis-id="' +
__e( vis.id ) +
...
__e( geomType ) +
'Dataset"></div>\n        </div>\n        <div class="DatasetCard-contentBodyDetails--right u-ellipsLongText">\n          <h3 class="DatasetCard-title DefaultTitle CDB-Text is-semibold u-ellipsLongText">\n            <a href="//' +
__e( vis.username ) +
'.' +
__e( account_host ) +
'/tables/' +
...
__e( cdb.Utils.formatNumber(vis.mapviews) ) +
'</span> <span class="MapCardIcon-label">view' +
__e( vis.mapviews !== 1 ? 's' : '' ) +
'</span>\n              </div>\n\n              ';
 if (vis.tags && vis.tags.length > 0) { ;
__p += '\n              <div class="MapCard-contentFooterIcon u-hideOnMobile">\n                <i class="CDB-IconFont CDB-IconFont-label"></i>\n                ' +
__e( vis.tags && vis.tags[0] ) +
'\n              </div>\n              ';
 } ;
__p += '\n\n              ';
 if (datasetSize && datasetSize[0] > 0) { ;
...
__p += '\n\n              <div class="MapCard-contentFooterIcon u-hideOnMobile">\n                <i class="CDB-IconFont CDB-IconFont-rows CDB-IconFont--small"></i>\n                <span class="MapCardIcon-counter">' +
__e( cdb.Utils.formatNumber(vis.rows) ) +
'</span> <span class="MapCardIcon-label">row' +
__e( vis.rows !== 1 ? 's' : '' ) +
'</span>\n              </div>\n\n              <div class="MapCard-contentFooterIcon">\n                <i class="CDB-IconFont CDB-IconFont-clock"></i>\n                ' +
__e( moment(date).fromNow() ) +
'\n              </div>\n            </div>\n\n            <div class="MapCard-contentFooterDetails--right">\n              <a href="#/like" class="LikesIndicator js-like is-likeable" data-vis-id="' +
__e( vis.id ) +
...
__e( vis.likes ) +
'</span>\n                <span class="CDB-Text CDB-Size-medium LikesIndicator-label">like' +
__e( vis.likes !== 1 ? 's' : '' ) +
'</span>\n              </a>\n            </div>\n\n          </div>\n\n        </div>\n\n      </div>\n    </div>\n  </div>\n</li>\n';
...
this["JST"]["cartodb/explore/dropdown_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<ul class="SettingsDropdown">\n  <li class="SettingsDropdown-item">\n    <p><button class="SettingsDropdown-itemLink SettingsDropdown-itemButtonLink js-both">Maps and datasets</button></p>\n    <p><button class="SettingsDropdown-itemLink SettingsDropdown-itemButtonLink js-maps">Maps</button></p>\n    <p><button class="SettingsDropdown-itemLink SettingsDropdown-itemButtonLink js-datasets">Datasets</button></p>\n  </li>\n</ul>\n';

}
return __p
};

this["JST"]["cartodb/explore/loading"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="IntermediateInfo IntermediateInfo--pullUp IntermediateInfo--flex">\n  <div class="Spinner"></div>\n  <h4 class="CDB-Text CDB-Size-large u-mainTextColor u-secondaryTextColor u-bSpace--m">' +
__e( title ) +
'</h4>\n  <div class="CDB-Text CDB-Size-medium u-altTextColor">' +
((__t = ( quote )) == null ? '' : __t) +
'</div>\n</div>\n';
...
this["JST"]["cartodb/explore/map_item_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
'" class="FeedItem-avatar">\n    <img src="' +
__e( vis.avatar_url ) +
'" class="UserAvatar-img UserAvatar-img--big" />\n  </a>\n\n  <div class="MapCard MapCard--borderless MapCard--explore js-card" data-vis-id="' +
__e( vis.id ) +
'">\n    <a href="//' +
__e( vis.username ) +
'.' +
...
'</span> <span class="MapCardIcon-label">view' +
__e( vis.mapviews !== 1 ? 's' : '' ) +
'</span>\n        </div>\n        <div class="MapCard-contentFooterIcon u-hideOnMobile">\n          <i class="CDB-IconFont CDB-IconFont-rows CDB-IconFont--small"></i>\n          <span clas="MapCardIcon-counter">' +
__e( cdb.Utils.formatNumber(vis.map_datasets) ) +
'</span> <span class="MapCardIcon-label">dataset' +
__e( vis.map_datasets !== 1 ? 's' : '' ) +
'</span>\n        </div>\n        <div class="MapCard-contentFooterIcon">\n          <i class="CDB-IconFont CDB-IconFont-clock"></i>\n          <span class="MapCardIcon-counter">' +
__e( moment(date).fromNow() ) +
'</span>\n        </div>\n        </div>\n\n        <div class="MapCard-contentFooterDetails--right">\n        <a href="#/like" class="LikesIndicator js-like is-likeable" data-vis-id="' +
__e( vis.id ) +
...
this["JST"]["cartodb/explore/template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="ContextMenu js-explore-context-menu">\n  <div class="u-inner">\n    <div class="ContextMenu-row">\n      <button class="ContextMenu-dropdown js-dropdown">\n        <span class="js-dropdownLabel">Maps and datasets</span>\n        <i class="ContextMenu-dropdownArrow CDB-IconFont CDB-IconFont-arrowMenu"></i>\n      </button>\n      <div class="ContextMenu-group is-hidden js-filters">\n        <span class="ContextMenu-label">Recent activity by</span>\n        <ul class="ContextMenu-group">\n          <li class="ContextMenu-groupItem">\n            <a data-title="likes" class="js-order-link ContextMenu-orderLink ContextMenu-orderLink--heart js-likes is-selected" href="#/likes">\n              <i class="CDB-IconFont CDB-IconFont-heartFill"></i>\n            </a>\n          </li>\n          <li class="ContextMenu-groupItem">\n            <a data-title="visits" class="js-order-link ContextMenu-orderLink ContextMenu-orderLink--graph js-mapviews" href="#/views">\n              <i class="CDB-IconFont CDB-IconFont-eye CDB-IconFont--big"></i>\n            </a>\n          </li>\n          <li class="ContextMenu-groupItem">\n            <a data-title="date" class="js-order-link ContextMenu-orderLink ContextMenu-orderLink--clock js-updated_at" href="#/time">\n              <i class="CDB-IconFont CDB-IconFont-clock"></i>\n            </a>\n          </li>\n        </ul>\n      </div>\n    </div>\n  </div>\n</div>\n<div class="Explore-inner">\n  <div class="Explore-feed js-feed">\n    <div class="Feed-content Explore-content">\n      <div class="FeedMast is-hidden js-mast">\n        <div class="FeedMast-ball FeedMast-ball--top"></div>\n        <div class="FeedMast-ball FeedMast-ball--bottom"></div>\n      </div>\n      <ul class="js-items"></ul>\n    </div>\n    <button class="Button Button--gray Button--centered is-hidden js-more">View more</button>\n  </div>\n</div>\n';

}
return __p
};

this["JST"]["cartodb/keys/views/regenerate_keys_dialog"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
__e( type === "api" ? 'API key' : 'OAuth credentials' ) +
...
__p += '\n      ' +
__e( person_scope ) +
' will need to update all deployed apps with the new API key. Are you sure you want to continue?\n    ';
 } else { ;
__p += '\n      ' +
__e( person_scope ) +
...
this["JST"]["cartodb/organization/flash_message"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/groups_admin/add_or_remove_group_users_filters_extra"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/groups_admin/create_group"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/groups_admin/edit_group"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/groups_admin/empty_group_filters_extra"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/groups_admin/error"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="FlashMessage FlashMessage--error CDB-Text">\n  <div class="u-inner">\n    <p class="FlashMessage-info">' +
__e( str ) +
'</p>\n  </div>\n</div>\n';
...
this["JST"]["cartodb/organization/groups_admin/group"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
this["JST"]["cartodb/organization/groups_admin/group_header"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
this["JST"]["cartodb/organization/groups_admin/group_user"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/groups_admin/groups_index_filters_extra"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="' +
...
this["JST"]["cartodb/organization/icon_picker/icon_picker_dialog/assets_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="js-dialogIconPicker">\n</div>\n';

}
return __p
};

this["JST"]["cartodb/organization/icon_picker/icon_picker_dialog/icon_picker_dialog_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/icon_picker/icon_picker_dialog/navigation_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<li class="CDB-NavMenu-item is-disabled js-your-icons' +
__e( pane === 'your_icons' ? ' is-selected' : '' ) +
...
this["JST"]["cartodb/organization/icon_picker/icons/delete_icons_modal"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
this["JST"]["cartodb/organization/icon_picker/icons/organization_icon"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/icon_picker/icons/organization_icons_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/icon_picker/organization_icon_picker_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/invite_users/invite_users_dialog_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/invite_users/invite_users_flash_message_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/invite_users/invite_users_form_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
this["JST"]["cartodb/organization/organization_notification/delete_notification_dialog"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/organization_notification/send_button"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
'</p>\n\n<button type="submit" class="OrganizationNotifications-button CDB-Button CDB-Button--primary ';
 if (isDisabled) { ;
__p += 'is-disabled';
 } ;
...
this["JST"]["cartodb/organization/organization_users/add_users_template"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
'">Create User</a></li>\n  <li class="DropdownList-item DropdownList-item--verticalPadding"><a href="' +
__e( createUrl ) +
'" class="js-inviteUser">Invite User</a></li>\n</ul>\n';

}
return __p
};

this["JST"]["cartodb/organization/organization_users/organization_user"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
this["JST"]["cartodb/organization/organization_users/organization_users"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/organization/organization_users/organization_users_footer"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
...
this["JST"]["cartodb/organization/views/delete_org_user"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<form accept-charset="UTF-8" action="' +
...
this["JST"]["cartodb/organization/views/quota_dropdown"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="UserQuotaDropdown">\n  <h4 class="UserQuotaDropdown-title">Change ' +
__e( userName ) +
' quota</h4>\n  <div class="UserQuotaDropdown-quota">\n    <p class="UserQuotaDropdown-info"><span class="js-userQuota">' +
__e( userQuotaPer ) +
'%</span> of the available org quota</p>\n    <div class="UISlider UserQuotaDropdown-slider js-slider"></div>\n  </div>\n</div>\n';
...
this["JST"]["cartodb/public_table/views/empty_table_public"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/public_table/views/maptab_public"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["cartodb/public_table/views/public_table_header_view"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
